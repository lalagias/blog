  ...
  return (
    <section className="w-full">
      ...
      <p className="text-neutral-600 dark:text-neutral-400 mb-8">
        Following the vibe coding and build in public trends, I will share all
        my projects here. Maybe this is a good way to keep myself accountable
        and to get feedback from the community. Or just a journal of my
        projects. I'm not sure yet.
      </p>
